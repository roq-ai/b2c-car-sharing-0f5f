...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'car.update': {
    roles: ['driver'],
    key: 'car-assignment',
    tenantPath: ['company', 'user', 'driver', 'car'],
    userPath: [],
  },
  'booking.create': {
  ...
  'driver.update': {
    roles: ['fleet-manager'],
    key: 'driver-availability-update',
    tenantPath: ['company', 'user', 'driver'],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['owner', 'fleet-manager', 'admin', 'driver'];
